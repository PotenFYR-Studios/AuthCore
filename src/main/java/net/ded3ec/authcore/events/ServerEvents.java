...
public class ServerEvents {
    ...
    public static void onPlayerJoin(ServerPlayNetworkHandler handler, PacketSender sender, MinecraftServer server) {
        ...
        else if (!AuthCore.config.session.authentication.allowOnlineNameByOffline && Misc.getPreimumUuid(user.username) != null && Misc.getPremiumUsername(handler.getPlayer().getUuid()) == null)
