...
public class Config {
    ...
    public static class UserCommands {
        ...
        public CommandPermissions login = new CommandPermissions() {
            {
        ...
        public CommandPermissions logout = new CommandPermissions() {
            {
        ...
        public CommandPermissions register = new CommandPermissions() {
            {
        ...
        public CommandPermissions unregister = new CommandPermissions() {
            {
        ...
        public CommandPermissions changepassword = new CommandPermissions() {
            {
    ...
    public static class AdminCommands {
        ...
        public CommandPermissions reload = new CommandPermissions() {
            {
        ...
        public CommandPermissions deletePlayer = new CommandPermissions() {
            {
        ...
        public CommandPermissions listPlayers = new CommandPermissions() {
            {
        ...
        public CommandPermissions listOnlineModePlayers = new CommandPermissions() {
            {
        ...
        public CommandPermissions listOfflineModePlayers = new CommandPermissions() {
            {
        ...
        public CommandPermissions destroyPlayerSession = new CommandPermissions() {
            {
        ...
        public CommandPermissions setPlayerPassword = new CommandPermissions() {
            {
        ...
        public CommandPermissions whoisUsername = new CommandPermissions() {
            {
        ...
        public CommandPermissions setOfflineModePlayer = new CommandPermissions() {
            {
        ...
        public CommandPermissions setOnlineModePlayer = new CommandPermissions() {
            {
        ...
        public CommandPermissions setSpawnLocation = new CommandPermissions() {
            {
    ...
    public static class Session {
        ...
        public static class Authentication {
            ...
            @Comment("""
                    ...
                    • Default: false""")
            public boolean offlineModeByDefault = false;
    ...
    public static class PasswordRules {
        ...
        public PasswordRule upperCase = new PasswordRule() {
            {
                min = 1;
                max = 10;
            }
        ...
        public PasswordRule lowerCase = new PasswordRule() {
            {
                min = 3;
                max = 10;
            }
        ...
        public PasswordRule digits = new PasswordRule() {
            {
                min = 4;
                max = 10;
            }
        ...
        public PasswordRule length = new PasswordRule() {
            {
                min = PasswordRules.this.upperCase.min + PasswordRules.this.lowerCase.min + PasswordRules.this.digits.min;
                max = PasswordRules.this.upperCase.max + PasswordRules.this.lowerCase.max + PasswordRules.this.digits.max;
            }
        };
