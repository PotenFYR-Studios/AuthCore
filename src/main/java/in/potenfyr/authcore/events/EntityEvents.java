...
public class EntityEvents {
  ...
  public static boolean guardLobbyAttack(User user, Entity entity) {
    ...
    if (in.potenfyr.authcore.compat.Compat.isMountable(entity)
  ...
  public static InteractionResult onEntityAttack(
    ...
    if (user != null && user.isInLobby.get()) {
      ...
      if (guardLobbyAttack(user, entity))
        return in.potenfyr.authcore.compat.Compat.actionResultFail();
      ...
      in.potenfyr.authcore.models.Config.Session.CombatLogConfig cfg = AuthCoreServer.config.session.combatLog;
      if (cfg.enabled) {
