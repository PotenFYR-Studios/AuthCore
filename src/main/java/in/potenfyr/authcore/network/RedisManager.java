      ...
      AuthCoreServer.LOGGER.error(
          ...
          "["
              + in.potenfyr.authcore.util.ErrorCodes.code(
                  in.potenfyr.authcore.util.ErrorCodes.Module.REDIS, in.potenfyr.authcore.util.ErrorCodes.Kind.CONNECTION, 1)
  ...
  private static void handleEvent(String json) {
    try {
      ...
      if ("kick".equals(type) || "logout".equals(type)) {
        in.potenfyr.authcore.models.User user = in.potenfyr.authcore.models.User.getUserByUsername(username);
