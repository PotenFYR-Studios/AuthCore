...
// Messages class containing all configurable message templates for the AuthCoreServer mod
@ConfigSerializable
public class Messages {
  ...
  @Comment(
      """
              Prompt shown when a user with 2FA enabled logs in but no valid TOTP code is provided.
              • Default display: Title in RED with a RED subtitle
              """)
  public ColTemplate promptUserMissing2faCode =
      new ColTemplate() {
        {
          title =
              new Title() {
                {
                  text = "2FA Code Not Found";
                  color = "RED";
                  subtitle =
                      new Template() {
                        {
                          text =
                              "Provide the \"<2fa-code>\" from your authenticator while executing the command.";
                          color = "RED";
                        }
                      };
                }
  ...
  @Comment(
      """
             Prompt shown when a user with 2FA enabled provides an incorrect TOTP code.
             • Default display: Title in RED with a RED subtitle
             """)
  public ColTemplate promptUserWrong2faCode =
      new ColTemplate() {
        {
          title =
              new Title() {
                {
                  text = "2FA Code is Wrong";
                  color = "RED";
                  subtitle =
                      new Template() {
                        {
                          text =
                              "Provide the correct \"<2fa-code>\" from your authenticator when executing the command.";
                          color = "RED";
                        }
                      };
                }
  ...
  @Comment(
      """
            Confirmation message sent to administrators after reloading the AuthCoreServer configuration.
            • Default display: Action bar in GREEN""")
      ...
      new ColTemplate() {
        {
          actionBar =
              new ActionBar() {
                {
                  text = "AuthCoreServer configuration files has been reloaded successfully!";
                  color = "GREEN";
                }
              };
        }
