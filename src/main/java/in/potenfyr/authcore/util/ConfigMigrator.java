...
public final class ConfigMigrator {
  ...
  public static void refreshEnrichedMessageDefaults() {
    try {
      in.potenfyr.authcore.models.Messages defaults = new in.potenfyr.authcore.models.Messages();
      java.lang.reflect.Field[] fields = in.potenfyr.authcore.models.Messages.class.getFields();
      ...
      for (java.lang.reflect.Field field : fields) {
        ...
        if (!(current instanceof in.potenfyr.authcore.models.Messages.ColTemplate cur)
            || !(fresh instanceof in.potenfyr.authcore.models.Messages.ColTemplate fr)) continue;
      ...
      try {
        in.potenfyr.authcore.models.Messages.ColTemplate loggedIn =
